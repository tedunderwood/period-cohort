...
multi.book.long <- multi.book %>% 
  ...
  group_by(hathi_author) %>% mutate(triples = n()) 
```
...
save(results, file = "sem_topic_results.Rdata") #results for all models for all topics
save(winners, file = "sem_topic_preferred.Rdata") #verdict (pref. model) for all topics
```
